          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" className="bg-white text-primary hover:bg-white/95 hover-scale-sm text-lg px-10 py-6 h-auto shadow-2xl font-semibold" onClick={() => navigate('/registrarse')}>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {pricingTiers.map((tier, index) => <Card key={index} className={`p-8 ${tier.highlight ? 'ring-2 ring-primary shadow-2xl scale-105' : ''} bg-white relative`}>
                  ...
                  <Button className="w-full" variant={tier.highlight ? 'default' : 'outline'} onClick={() => navigate('/registrarse')}>
                    Solicitar Ahora
                  </Button>
                </Card>)}
            </div>
        ...
        <section className="py-20 bg-gradient-to-br from-primary to-navy">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" className="bg-white text-primary hover:bg-white/95 text-lg px-10 py-6 h-auto shadow-2xl font-semibold" onClick={() => navigate('/registrarse')}>
